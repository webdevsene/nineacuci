    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ->add('chiffreAffaire',TextType::class,
                   ...
                   'required'=>false,
                   'attr'=>array('class'=>'form-control  form-control-sm chiffreAffaire',  'oninput'=>"this.value = this.value.replace(/[^0-9,]/g, '');")))
            ->add('pourcentage',TextType::class,
                   array('label'=>'Pourcentage ',
                   'required'=>false,
                   'attr'=>array(
                    'oninput'=>"this.value = this.value.replace(/[^0-9,]/g, '');",
                       'class'=>'form-control form-control-sm pourcentageActivite',
                       'min'=>0,
                       'max'=>100
                    )))
            ->add('valeurAjoutee',TextType::class,
                   ...
                   'required'=>false,
                   'attr'=>array('class'=>'form-control form-control-sm valeurAjoutee',  'oninput'=>"this.value = this.value.replace(/[^0-9,-]/g, '');")))
