          ...
          ->add('telephone2',TextType::class,
           ...
           ->add('boitePostale',TextType::class,
            ...
            ->add('chiffreAffaire',TextType::class,
                   array('label'=>' ',
                          'required'=>false,
                          'mapped'=>false,
                          'attr'=>array( 'oninput'=>"this.value = this.value.replace(/[^0-9,]/g, '');",'class'=>'form-control form-control-sm chiffreAffaire')
            ))
           ...
           ->add('valeurAjoutee',TextType::class,
                   array('label'=>' ',
                          'required'=>false,
                          'mapped'=>false,
                          'attr'=>array('oninput'=>"this.value = this.value.replace(/[^0-9,]/g, '');",'class'=>'form-control form-control-sm valeurAjoutee')
            ))
           ...
           ->add('pourcentage',IntegerType::class,
                   array('label'=>' ',
                          'required'=>false,
                          'mapped'=>false,
                          'attr'=>array('class'=>'form-control form-control-sm pourcentageActivite',
                            "min"=>0,
                            "max"=>100,
                     )
            ))
