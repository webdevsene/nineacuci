...
class LoggableListener extends MappedEventSubscriber
{
    ...
    public function setUsername($username)
    {
        if (is_string($username)) {
            ...
            throw new \Gedmo\Exception\InvalidArgumentException('Username must be a string, or object should have method getUserIdentifier,
            getUsername or __toString');
