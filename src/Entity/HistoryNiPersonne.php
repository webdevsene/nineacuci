...
use App\Repository\HistoryNiPersonneRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=HistoryNiPersonneRepository::class)
 */
class HistoryNiPersonne
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\ManyToOne(targetEntity=NiSexe::class, inversedBy="historyNiPersonnes")
     */
    private $ninSexe;
    ...
    /**
     * @ORM\ManyToOne(targetEntity=NiCivilite::class, inversedBy="historyNiPersonnes")
     */
    private $civilite;

    /**
     * @ORM\ManyToOne(targetEntity=Pays::class, inversedBy="historyNiPersonnes")
     */
    private $nationalite;

    /**
     * @ORM\ManyToOne(targetEntity=User::class, inversedBy="historyNiPersonnes")
     */
    private $createdBy;

    /**
     * @ORM\ManyToOne(targetEntity=QVH::class, inversedBy="historyNiPersonnes")
     */
    private $ninQvh;
    ...
    /**
     * @ORM\ManyToOne(targetEntity=NiTypevoie::class, inversedBy="historyNiPersonnes")
     */
    private $ninTypevoie;
    ...
    /**
     * @ORM\OneToMany(targetEntity=HistoryNINinea::class, mappedBy="historyNiPersonne")
     */
    private $ninNinea;

    /**
     * @ORM\OneToMany(targetEntity=HistoryNiNineaproposition::class, mappedBy="historyNiPersonne")
     */
    ...
    public function addNinNinea(HistoryNINinea $ninNinea): self
    {
        if (!$this->ninNinea->contains($ninNinea)) {
            $this->ninNinea[] = $ninNinea;
            $ninNinea->setHistoryNiPersonne($this);
        }

        return $this;
    }

    public function removeNinNinea(HistoryNINinea $ninNinea): self
    {
        if ($this->ninNinea->removeElement($ninNinea)) {
            // set the owning side to null (unless already changed)
            if ($ninNinea->getHistoryNiPersonne() === $this) {
                $ninNinea->setHistoryNiPersonne(null);
            }
        }
    ...
    public function addNiNineaproposition(HistoryNiNineaproposition $niNineaproposition): self
    {
        if (!$this->niNineapropositions->contains($niNineaproposition)) {
            $this->niNineapropositions[] = $niNineaproposition;
            $niNineaproposition->setHistoryNiPersonne($this);
        }

        return $this;
    }

    public function removeNiNineaproposition(HistoryNiNineaproposition $niNineaproposition): self
    {
        if ($this->niNineapropositions->removeElement($niNineaproposition)) {
            // set the owning side to null (unless already changed)
            if ($niNineaproposition->getHistoryNiPersonne() === $this) {
                $niNineaproposition->setHistoryNiPersonne(null);
            }
        }
