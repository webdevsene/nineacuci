...
t("#sa-params").click(function(e)

	{
		...
		Swal.fire({
		title:"Confirmation",
		text:"Êtes-vous sûr de vouloir sortir de cette écran sans sauvegarder cet enrégistrement?",
		icon:"warning",
...

	{
		...
		Swal.fire({
		title:"Confirmation",
		text:"Êtes-vous sûr de vouloir retourner à la liste des répertoires?",
		icon:"warning",
		showCancelButton:true,
		confirmButtonText:"Oui",
		cancelButtonText:"Non",
  ...
  t(".sauvegarder").click(function(e)
    ...
    t(".sauvegarderPassif").click(function(e)
